...
[Cytoscape](https://cytoscape.org/) and [EnrichmentMap App](http://apps.cytoscape.org/apps/enrichmentmap) are used for visualization following this awesome [protocol].
...
## Work flow
---
### Download raw data, see **Data availability** section in our paper to download raw data.
